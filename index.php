  ...
  <div class="wrap">
    ...
    <nav class="main-nav">
      <ul>
        ...
        <li><a href="#ingredients">المكونات</a></li>
        <li><a href="#product">المنتج</a></li>
        <li><a href="#how">طريقة الاستخدام</a></li>
      </ul>
    </nav>
...
<section class="hero">
  ...
  <div class="wrap">
    <div class="hero-content">
      ...
      <p>زيت Crown مستخلص من الأرغان والروزماري وزيت الزيتون، يغذّي بصيلات الشعر من الجذور ويعيد له الكثافة واللمعان الطبيعي.</p>
      <div class="hero-cta">
        <a href="store.php" class="btn btn-primary">اطلب زجاجتك الآن</a>
        <a href="#ingredients" class="btn btn-ghost-light">تعرّف على المكونات</a>
      </div>
    </div>
    <ul class="hero-badges">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M12 3c4 3 7 6 7 10a7 7 0 11-14 0c0-4 3-7 7-10z"/></svg> مكونات طبيعية 100٪</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg> نتائج من أول 4 أسابيع</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M5 12l4 4L19 6"/></svg> بدون سيليكون أو كبريتات</li>
    </ul>
  </div>
</section>
...
<section class="section-cream" id="about">
  <div class="wrap about-grid">
    ...
    <div class="about-text">
      ...
      <p>النتيجة زيت واحد مركّز، يجمع بين أرغان المغرب وروزماري البحر المتوسط وزيت الزيتون البكر، في زجاجة واحدة بسيطة تُستخدم مرتين أسبوعياً فقط.</p>
      <div class="about-stats">
        <div class="stat"><b>100٪</b><span>مكونات طبيعية</span></div>
        <div class="stat"><b>0٪</b><span>سيليكون وكبريتات</span></div>
        <div class="stat"><b>3</b><span>زيوت نشطة مركّزة</span></div>
      </div>
    </div>
  </div>
</section>
...
<!-- MOTIF STRIP — line-art hair texture, no human imagery -->
<div class="motif-strip">
  <svg viewBox="0 0 1200 220" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="strandFade" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0" stop-color="#B8924A" stop-opacity="0"/>
        <stop offset="0.5" stop-color="#B8924A" stop-opacity="0.9"/>
        <stop offset="1" stop-color="#B8924A" stop-opacity="0"/>
      </linearGradient>
    </defs>
    <g fill="none" stroke="url(#strandFade)" stroke-width="1.1" stroke-linecap="round">
      <path d="M-20 30 C 150 10, 250 70, 400 40 S 650 0, 800 50 1050 10 1230 40"/>
      <path d="M-20 70 C 180 110, 300 30, 460 80 S 700 120, 880 70 1080 110 1230 75"/>
      <path d="M-20 110 C 200 70, 320 150, 500 110 S 760 60, 940 120 1120 80 1230 110"/>
      <path d="M-20 150 C 160 190, 280 120, 440 160 S 680 200, 860 150 1060 190 1230 155"/>
      <path d="M-20 190 C 220 150, 340 210, 520 180 S 780 140, 960 195 1140 160 1230 190"/>
    </g>
  </svg>
</div>
    ...
    <div class="ring-wrap">
      <div class="ring-diagram">
        <svg viewBox="0 0 460 460" xmlns="http://www.w3.org/2000/svg">
          ...
          <g stroke="#A85C32" stroke-width="1.3" fill="none">
            <path d="M230 132 v-30"/>
            <path d="M230 328 v30"/>
            <path d="M328 230 h30"/>
            <path d="M132 230 h-30"/>
          </g>
          <circle cx="230" cy="230" r="46" fill="#211D17"/>
          <text x="230" y="226" text-anchor="middle" fill="#F6F1E6" font-family="Cairo" font-weight="700" font-size="17">Crown</text>
          <text x="230" y="246" text-anchor="middle" fill="#E7C892" font-family="IBM Plex Sans Arabic" font-size="9" letter-spacing="2">HAIR OIL</text>
          <circle cx="230" cy="80" r="5" fill="#A85C32"/>
          <circle cx="380" cy="230" r="5" fill="#6E7456"/>
          <circle cx="230" cy="380" r="5" fill="#B8924A"/>
        </svg>
        <div class="ring-node" style="top:-6px;right:50%;transform:translateX(50%);">
          <h4>أرغان</h4>
          <p>يغذّي ويرمم الخصلة من الأطراف.</p>
        </div>
        <div class="ring-node" style="top:42%;right:-10px;">
          <h4>روزماري</h4>
          <p>ينشّط فروة الرأس ويحفّز النمو.</p>
        </div>
        <div class="ring-node" style="bottom:-6px;right:50%;transform:translateX(50%);">
          <h4>زيت الزيتون</h4>
  ...
  <div class="wrap">
    <div class="footer-grid">
      <div class="footer-brand">
        <img src="assets/logo.jpg" alt="Crown Hair Oil">
        <p>زيت طبيعي 100٪ للعناية بالشعر، من مزيج الأرغان والروزماري وزيت الزيتون. صُمم لروتين عناية بسيط وفعّال.</p>
      </div>
      <div>
        <h4>الموقع</h4>
        <ul>
      ...
      <div>
        <h4>المتجر</h4>
        <ul>
          <li><a href="store.php">جميع المنتجات</a></li>
          <li><a href="store.php#checkout">طرق الدفع والشحن</a></li>
        </ul>
      </div>
      <div>
        <h4>تابعونا</h4>
        <ul>
          <li><a href="#">@CrownHairOil_KSA</a></li>
          <li><a href="#">[رابط الموقع]</a></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <span>© Crown Hair Oil — جميع الحقوق محفوظة</span>
      <span>صُنع بعناية لكل أنواع الشعر</span>
    </div>
  </div>
</footer>
